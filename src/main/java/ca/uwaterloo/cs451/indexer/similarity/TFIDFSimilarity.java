...
public class TFIDFSimilarity extends BaseSimilarity{
    ...
    public TFIDFSimilarity(SimilarityType type) {
        super(type);
    }
...
//    }
    ...
    public HashMap<Integer, Double> getTFIDFScores() throws Exception {
...
//        }
    ...
    public List<String> getRelevantDocs(HashMap<String, PostingsInfo> map, int topK) throws Exception {
        this.ogMap = map;
        HashMap<Integer, Double> scores = this.getTFIDFScores();
